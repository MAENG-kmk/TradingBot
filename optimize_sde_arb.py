...
def main():
    ...
    closes = load_data(DATA_PATH)
    print(f"  {len(closes)}봉")
    ...
    for idx, combo in enumerate(combos):
        ...
        # stop_ror < target_ror 조건 (손익비 최소 1:1 보장)
